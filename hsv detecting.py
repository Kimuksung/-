# -*- coding: utf-8 -*-
"""
Created on Tue May 14 16:31:32 2019
...
while success:
	...
	#blue range
    lower_blue = np.array([110,0,200])
    upper_blue = np.array([150,50,255])
    ...
    for c in contours:
        ...
        if(h>=(1.5)*w):
            if(w>15 and h>= 15):
                ...
                if(nzCount >= 30):
					#Mark white jersy players as white
                    cv2.putText(image, 'White', (x-2, y-2), font, 0.8, (255,0,0), 2, cv2.LINE_AA)
                    cv2.rectangle(image,(x,y),(x+w,y+h),(255,0,0),3)
                else:
                    pass
                
                if(nzCountred>=30):
					#Mark red jersy players as red
